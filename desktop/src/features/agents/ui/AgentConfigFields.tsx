...
export const shouldAutoSelectModelForProvider = (provider: string) =>
  provider.trim() !== "ai-gateway";
 ...
 * Discovery failures keep failure UI visible. Required-model harnesses always
 * render the control.
 */
